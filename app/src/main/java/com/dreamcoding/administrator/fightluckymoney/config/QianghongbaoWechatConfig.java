package com.dreamcoding.administrator.fightluckymoney.config;

import android.content.Context;
import android.content.SharedPreferences;

/**
 * Created by Administrator on 2016/9/27 0027 上午 12:10.
 */
public class QianghongbaoWechatConfig {
    ...
    //修改
    public static final String PREFERENCE_NAME = "QianghongbaoWechatConfig";
    ...
    private static QianghongbaoWechatConfig current;

    public static synchronized QianghongbaoWechatConfig getConfig(Context context) {
        if(current == null) {
            current = new QianghongbaoWechatConfig(context.getApplicationContext());
        }
        return current;
    }
    ...
    private QianghongbaoWechatConfig(Context context) {
        mContext = context;
